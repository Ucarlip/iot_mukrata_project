                ...
                Row(
                  children: [
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          if (isAdult == true && adultCtrl.text.isEmpty ||
                              adultCtrl.text == '0') {
                            showWarningDialog(
                                context, 'กรุณากรอกจำนวนผู้ใหญ่ด้วย');
                          } else if (isChild == true &&
                                  childCtrl.text.isEmpty ||
                              adultCtrl.text == '0') {
                            showWarningDialog(
                                context, 'กรุณากรอกจำนวนเด็กด้วย');
                          } else {
                            //คำนวณเงิน
                            //เตรียมข้อมูลที่ใช้ในการคำนวณ
                            int numAdult =
                            ...
                            //คำนวณที่ต้องจ่ายหลังหักส่วนลดเเล้ว
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () {
                          //ทุกอย่างบนหน้าจอกลับเป็นค่าเริ่มต้นหรือเหทือนเดิม
                          setState(
                            () {
                              imgFile = null;
                              isAdult = false;
